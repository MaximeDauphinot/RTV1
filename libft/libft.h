...
/*   Updated: 2017/12/21 02:43:51 by mdauphin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define N "\n"
# define DG(f, ...) printf(_G f N, __FILE__,__FUNCTION__,__LINE__, __VA_ARGS__)
# define GD(f) printf(_G f N, __FILE__,__FUNCTION__,__LINE__)
# define BUFF_SIZE 42
# define NBFD 5000
